/*
  # Ensure Admin User Setup - Database migration to ensure proper admin user configuration

  1. Tables - Database table creation and validation
    - Ensures user_roles table exists - Creates table for user role management if not present
    - Ensures user_progress table exists - Creates table for tracking user progress if not present
  ...
  2. Security - Row Level Security configuration and access policies
    ...
    - Add policies for admin access - Create access control policies for administrative users
    
  3. Admin Setup - Administrative user configuration and role assignment
    - Creates admin role entry for neoguru@gmail.com - Assigns admin privileges to specific email
*/
