...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: "To inform you of any site-specific hazards and ground conditions; To ensure that you adhere to any workplace policies and site-specific procedures",
    acceptableAnswers: [
  ...
  },
  {
    ...
    answer: "It is the possibility that harm (death, injury or illness) might happen when exposed to a hazard",
    acceptableAnswers: [
      "It is the possibility that harm (death, injury or illness) might happen when exposed to a hazard"
    ],
    inputFields: 2
  },
  {
